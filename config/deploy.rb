...
#set :linked_files, fetch(:linked_files, []).push('config/database.yml', 'config/secrets.yml', 'config/publication.yml', 'config/extern_uri.yml')

# Default value for linked_dirs is []
set :linked_dirs, fetch(:linked_dirs, []).push('certificat')
